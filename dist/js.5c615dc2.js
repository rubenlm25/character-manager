...
(function () {
  ...
  axios.get("https://character-database.becode.xyz/characters").then(function (resp) {
    console.table(resp.data); // déclaration variables 

    var template, item, a; // enregistrement du modèle du template
    ...
    for (i = 0; i < resp.data.length; i++) {
      // creation carte
      a = document.importNode(item, true); // remplissage carte et injection de l'id dans le HTML
      ...
      a.querySelector(".edit").setAttribute("data-id", resp.data[i].id); // ajout de la carte dans le dom
    ...
    document.querySelectorAll(".openchar").forEach(function (el) {
      el.addEventListener("click", function () {
        ...
        console.log(clickedid); // récupération du bon personnage sur l'API

        var selectedchar = resp.data.find(function (element) {
          return element.id == clickedid;
        });
        console.table(selectedchar); // remplissage de la page single image et stockage de l'id pour utilisation en cas d'edit
    ...
    document.querySelectorAll(".delete").forEach(function (el) {
      el.addEventListener("click", function () {
        ...
        if (confirm("Are you sure you want to delete this character?")) {
          ...
          axios.delete("https://character-database.becode.xyz/characters/" + dataid); // suppression de la carte perso dans le DOM
    ...
    document.querySelectorAll(".edit").forEach(function (el) {
      el.addEventListener("click", function () {
        ...
        var dataid = this.getAttribute("data-id");
        console.log(dataid); // enregestriment dans le local storage de l'id pour le récupérer sur la page d'édition

        localStorage.setItem("idedit", JSON.stringify(dataid)); // redirection sur la page d'édition
    ...
    document.querySelector(".maindelete").addEventListener("click", function () {
      ...
      if (confirm("Are you sure you want to delete this character?")) {
        ...
        axios.delete("https://character-database.becode.xyz/characters/" + dataid); // suppression de la carte personnage du DOM

        var nodetoremove = document.getElementById(dataid);
        console.log(nodetoremove);
        nodetoremove.parentNode.removeChild(nodetoremove); // désafficher la single image page
    ...
    document.querySelector(".mainedit").addEventListener("click", function () {
      ...
      console.log(dataid); // stockage de l'id dans le local storage poru le récupérer sur la page edit

      localStorage.setItem("idedit", JSON.stringify(dataid)); // ouverture page d'édition
