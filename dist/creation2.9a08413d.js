...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"assets/js/creation2.js":[function(require,module,exports) {
"use strict";
...
var openFile = function openFile(event) {
  ...
  reader.onload = function () {
    ...
    var matches = dataURL.match(xp);
    var ext = matches[1];
    var data = matches[2];
    console.log(data);
    console.log(dataURL.match(xp));
    var output = document.getElementById('previewAddCharImg');
    output.src = "data:image/JPEG;base64,".concat(data);
    return data;
  };
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","assets/js/creation2.js"], null)
//# sourceMappingURL=/creation2.9a08413d.js.map